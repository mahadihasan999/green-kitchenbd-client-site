...
const SideNav = () => {
    ...
    const menux =
        [
            // { id: 1, text: 'admin', to: "/admin },
            { id: 1, text: 'Manage All Orders', to: "/admin/manage-products" },
            { id: 2, text: 'Add New items', to: "/admin/add" },
            { id: 3, text: 'Make Admin', to: "/admin/makeAdmin" },
    ...
    const menuy =
        [
            // { id: 1, text: 'admin', to: "/admin },
            { id: 1, text: 'Pay', to: "/admin/pay" },
            { id: 2, text: 'My Order', to: "/admin/manage-my-order" },
            { id: 3, text: 'Add Review', to: "/admin/addReview" },
